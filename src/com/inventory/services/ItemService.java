...
public class ItemService {
    ...
    public List<Item> getAllItems() {
        ...
        String sql = "SELECT id, name, category, quantity, price, status FROM items ORDER BY id DESC";
    ...
    public List<Item> searchItems(String query) {
        List<Item> items = new ArrayList<>();
        String sql = "SELECT id, name, category, quantity, price, status FROM items WHERE name LIKE ? OR category LIKE ? ORDER BY id DESC";
        try (Connection conn = DatabaseManager.getConnection();
    ...
    public boolean addItem(Item item) {
        String sql = "INSERT INTO items (name, category, quantity, price, status) VALUES (?, ?, ?, ?, ?)";
        try (Connection conn = DatabaseManager.getConnection();
    ...
    public boolean updateItem(Item item) {
        String sql = "UPDATE items SET name = ?, category = ?, quantity = ?, price = ?, status = ? WHERE id = ?";
        try (Connection conn = DatabaseManager.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
    ...
    public boolean deleteItem(int id) {
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            System.err.println("Database error during deleteItem.");
            e.printStackTrace();
        }
        return false;
    }

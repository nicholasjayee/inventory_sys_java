...
public class UserService {
     ...
     * @param password The password (in a production environment, this would be salted/hashed).
    ...
    public User authenticate(String username, String password) {
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            stmt.setString(2, password); // Standard password comparison for simple setup
